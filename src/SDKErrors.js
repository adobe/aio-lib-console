...
E('ERROR_CREATE_OAUTH_SERVER_TO_SERVER_CREDENTIAL', '%s')
E('ERROR_CREATE_ENTERPRISE_CREDENTIAL', '%s')
E('ERROR_GET_PROJECT_INSTALL_CONFIG', '%s')
...
E('ERROR_SUBSCRIBE_OAUTH_SERVER_TO_SERVER_INTEGRATION_TO_SERVICES', '%s')
...
E('ERROR_GET_APPLICATION_EXTENSIONS', '%s')
E('ERROR_GET_WORKSPACE_ENDPOINTS', '%s')
E('ERROR_UPDATE_WORKSPACE_ENDPOINTS', '%s')
E('ERROR_GET_DEV_TERMS', '%s')
E('ERROR_GET_DEV_TERMS_ACCEPTANCE', '%s')
E('ERROR_POST_DEV_TERMS_ACCEPTANCE', '%s')
E('ERROR_CREATE_OAUTH_SERVER_TO_SERVER_CREDENTIAL_INTEGRATION', '%s')
E('ERROR_GET_WORKSPACE_INFO_FOR_RUNTIME_NAMESPACE', '%s')
E('ERROR_GET_PROJECT_NEXT_AVAILABLE_IDENTIFIERS', '%s')
