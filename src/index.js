...
class CoreConsoleAPI {
   ...
   * @param {string} [options.xp] xp
   * @returns {Promise<Response>} the response
   */
  async getExtensionsForOrg (organizationId, options = {}) {
    ...
    try {
      ...
      throw new codes.ERROR_GET_EXTENSIONS_FOR_ORG({ sdkDetails, messageValues: reduceError(err) })
    }
  }
   ...
   *
   * @param {string} organizationId Organization AMS ID
   * @param {ExtensionDetails} extensionDetails Extension details
   * @returns {Promise<Response>} the response
   */
  async createExtension (organizationId, extensionDetails) {
    const parameters = { orgId: organizationId }
    const requestBody = extensionDetails
    const sdkDetails = { parameters, requestBody }

    try {
      const res = await this.sdk.apis.Extensions
        .post_console_organizations__orgId__xr_api_v1_app(
          ...this.__createRequestOptions(parameters, requestBody)
        )
      return res
    } catch (err) {
      throw new codes.ERROR_CREATE_EXTENSION({ sdkDetails, messageValues: reduceError(err) })
    }
  }
  ...
  async submitExtension (organizationId, submisssionDetails) {
    const parameters = { orgId: organizationId }
    const requestBody = submisssionDetails
    const sdkDetails = { parameters, requestBody }

    try {
      const res = await this.sdk.apis.Extensions
        .patch_console_organizations__orgId__xr_api_v1_app(
          ...this.__createRequestOptions(parameters, requestBody)
        )
      return res
    } catch (err) {
      throw new codes.ERROR_SUBMIT_EXTENSION({ sdkDetails, messageValues: reduceError(err) })
    }
  }
   ...
   * @returns {Promise<Response>} the response
   */
  async updateExtension (organizationId, appId, extensionDetails) {
    const parameters = { orgId: organizationId, appId: appId }
    const requestBody = extensionDetails
    const sdkDetails = { parameters, requestBody }

    try {
      const res = await this.sdk.apis.Extensions
        .put_console_organizations__orgId__xr_api_v1_app__appId_(
          ...this.__createRequestOptions(parameters, requestBody)
        )
      return res
    } catch (err) {
      throw new codes.ERROR_UPDATE_EXTENSION({ sdkDetails, messageValues: reduceError(err) })
    }
  }
   ...
   * @returns {Promise<Response>} the response
   */
  async deleteExtension (organizationId, appId) {
    const parameters = { orgId: organizationId, appId: appId }
    const sdkDetails = { parameters }

    try {
      const res = await this.sdk.apis.Extensions
        .delete_console_organizations__orgId__xr_api_v1_app__appId_(
          ...this.__createRequestOptions(parameters)
        )
      return res
    } catch (err) {
      throw new codes.ERROR_DELETE_EXTENSION({ sdkDetails, messageValues: reduceError(err) })
    }
  }
   ...
   * @param {string} organizationId Organization AMS ID
   * @param {string} appId App ID
   * @param {ExtensionWorkspaceDetails} workspaceDetails Workspace details
   * @returns {Promise<Response>} the response
   */
  async createExtensionWorkspace (organizationId, appId, workspaceDetails) {
    const parameters = { orgId: organizationId, appId: appId }
    const requestBody = workspaceDetails
    const sdkDetails = { parameters, requestBody }
    ...
    try {
      const res = await this.sdk.apis.Extensions
        .post_console_organizations__orgId__xr_api_v1_app__appId__workspace(
          ...this.__createRequestOptions(parameters, requestBody)
        )
      return res
    } catch (err) {
      throw new codes.ERROR_CREATE_EXTENSION_WORKSPACE({ sdkDetails, messageValues: reduceError(err) })
    }
  }
  ...
  async updateExtensionWorkspace (organizationId, appId, workspaceId, workspaceDetails) {
    ...
    try {
      ...
      throw new codes.ERROR_UPDATE_EXTENSION_WORKSPACE({ sdkDetails, messageValues: reduceError(err) })
    }
  }
  ...
  async deleteExtensionWorkspace (organizationId, appId, workspaceId) {
    ...
    try {
      ...
      throw new codes.ERROR_DELETE_EXTENSION_WORKSPACE({ sdkDetails, messageValues: reduceError(err) })
    }
  }
  ...
  async getExtensionWorkspace (organizationId, appId, workspaceId) {
    ...
    try {
      ...
      throw new codes.ERROR_GET_EXTENSION_WORKSPACE({ sdkDetails, messageValues: reduceError(err) })
    }
  }
   ...
   * @returns {Promise<Response>} the response
   */
  async checkExtensionName (organizationId, appName) {
    const parameters = { orgId: organizationId, appName: appName }
    const sdkDetails = { parameters }
    try {
      const res = await this.sdk.apis.Extensions
        .get_console_organizations__orgId__xr_api_v1_app__appName_(
          ...this.__createRequestOptions(parameters)
        )
      return res
    } catch (err) {
      throw new codes.ERROR_CHECK_EXTENSION_NAME({ sdkDetails, messageValues: reduceError(err) })
    }
  }
